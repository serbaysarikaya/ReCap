...
namespace WebAPI.Controllers
{
    ...
    public class CarImagesController : ControllerBase
    {
        ...
        [HttpPost("add")]
        public IActionResult Add([FromForm] IFormFile file, [FromForm] CarImageDto carImage)
        {
        ...
        [HttpPost("update")]
        public IActionResult Update([FromForm] IFormFile file, [FromForm] CarImageDto carImage)
        {
